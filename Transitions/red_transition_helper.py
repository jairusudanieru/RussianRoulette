...
class RedTransitionHelper:
    def __init__(self, parent, stacked_widget):
        ...
        self.red_overlay = QWidget(self.parent)  # Here we pass the parent QWidget
        self.red_overlay.setGeometry(0, 0, 1280, 720)
        self.red_overlay.setStyleSheet("background-color: red;")
        self.red_overlay.raise_()
        self.red_overlay.setAttribute(Qt.WA_TransparentForMouseEvents)

        # Opacity effect for fading in/out
        self.overlay_effect = QGraphicsOpacityEffect(self.red_overlay)
        self.red_overlay.setGraphicsEffect(self.overlay_effect)
    ...
    def fade_and_switch(self, target_screen):
        ...
        self.red_overlay.setAttribute(Qt.WA_TransparentForMouseEvents, False)
        self.red_overlay.raise_()
    ...
    def restore_mouse(self):
        ...
        self.red_overlay.setAttribute(Qt.WA_TransparentForMouseEvents, True)
