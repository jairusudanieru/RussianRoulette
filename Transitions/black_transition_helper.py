...
class BlackTransitionHelper:
    def __init__(self, parent, stacked_widget):
        ...
        self.black_overlay = QWidget(self.parent)  # Here we pass the parent QWidget
        self.black_overlay.setGeometry(0, 0, 1280, 720)
        self.black_overlay.setStyleSheet("background-color: black;")
        self.black_overlay.raise_()
        self.black_overlay.setAttribute(Qt.WA_TransparentForMouseEvents)

        # Opacity effect for fading in/out
        self.overlay_effect = QGraphicsOpacityEffect(self.black_overlay)
        self.black_overlay.setGraphicsEffect(self.overlay_effect)
    ...
    def fade_and_switch(self, target_screen):
        ...
        self.black_overlay.setAttribute(Qt.WA_TransparentForMouseEvents, False)
        self.black_overlay.raise_()

        # Fade in the overlay
        self.fade_in_animation = self.create_fade_animation(self.overlay_effect, 0.0, 1.0, duration=800)
    ...
    def switch_and_fade_out(self, target_screen):
        ...
        self.fade_out_animation = self.create_fade_animation(self.overlay_effect, 1.0, 0.0, duration=800)
